...
export const BotIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c.251.023.501.05.75.082a9.75 9.75 0 0 1 8.25 8.25c.032.249.059.499.082.75m0 0H21m-2.25-2.25v2.25m0 0a2.25 2.25 0 0 0-1.659 4.091l-2.098 1.049a2.25 2.25 0 0 0-2.25 2.25v4.5m4.5-16.5-2.098 1.049a2.25 2.25 0 0 1-2.25 2.25h-4.5a2.25 2.25 0 0 1-2.25-2.25V5.25a2.25 2.25 0 0 1 2.25-2.25h9.75" />
    </svg>
);
